...
- **Technologies**: Vanilla HTML, Vanilla CSS, pure JavaScript — no frameworks (the `marked` library and `katex` library via CDN are permitted for client-side markdown parsing and math formula rendering to ensure correct rendering).
