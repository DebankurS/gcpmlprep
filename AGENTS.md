...
- **Integrity**: Questions in [public/questions/](./public/questions/) (`domain1.json` … `domain7.json`) must collectively total exactly **38** questions. Adding or removing questions will fail the test suite.
